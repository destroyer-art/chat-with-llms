...
export const modelOptions = [
    ...
    { label: "GPT-4 o", value: "gpt-4o", companyLogo: <RiOpenaiFill />, color: "text-blue-500", isPremium: true },
    { label: "GPT-4 o mini", value: "gpt-4o-mini", companyLogo: <RiOpenaiFill />, color: "text-blue-500", isPremium: true },
    ...
    { label: "Sonar Small Chat", value: "sonar-small-chat", companyLogo: <img src={perplexity} alt="" width={20} height={20} />, color: "text-blue-500", isPremium: false },
    { label: "Sonar Small Online", value: "sonar-small-online", companyLogo: <img src={perplexity} alt="" width={20} height={20} />, color: "text-blue-500", isPremium: true },
    { label: "Sonar Medium Chat", value: "sonar-medium-chat", companyLogo: <img src={perplexity} alt="" width={20} height={20} />, color: "text-blue-500", isPremium: false },
    { label: "Sonar Medium Online", value: "sonar-medium-online", companyLogo: <img src={perplexity} alt="" width={20} height={20} />, color: "text-blue-500", isPremium: true },
